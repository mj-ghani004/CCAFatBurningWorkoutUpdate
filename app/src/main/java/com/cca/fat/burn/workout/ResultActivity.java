...
//		adView.loadAd(adRequest);
        ...
        TextView t4 = findViewById(R.id.textViewResult_nameValue);
        TextView t1 = findViewById(R.id.textViewResult_genderValue);
        TextView t2 = findViewById(R.id.textViewResult_weightUnit);
        TextView t3 = findViewById(R.id.textViewResult_heightInch);
        TextView tv1 = findViewById(R.id.textViewResult_weightValue);
        TextView tv2 = findViewById(R.id.textViewResult_heightFeet);
        TextView tv3 = findViewById(R.id.textViewResult_ageValue);
        TextView tv4 = findViewById(R.id.textViewResult_bmiValue);
        TextView tv5 = findViewById(R.id.textViewResult_bmrValue);

        final TextView tv6 = findViewById(R.id.description);
