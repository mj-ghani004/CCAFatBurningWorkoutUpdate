...
public class ExerciseListAdapter extends RecyclerView.Adapter<ExerciseListAdapter.RecyclerViewHolder> {
    ...
    public ExerciseListAdapter(ArrayList<FoodProvider> foodData) {
    ...
    public RecyclerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.excercise_list_item, parent, false);
